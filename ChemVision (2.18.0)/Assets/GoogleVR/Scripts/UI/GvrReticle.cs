...
public class GvrReticle : MonoBehaviour, IGvrGazePointer {
  ...
  // (in degrees).
  private const float kReticleGrowthAngle = 2.5f;   // EDITED: was 1.5f
  ...
  private void UpdateDiameters() {
    ...
    float inner_diameter = 1.0f * Mathf.Tan(inner_half_angle_radians);    //  EDITED: was 2.0f
    float outer_diameter = 1.0f * Mathf.Tan(outer_half_angle_radians);    //  EDITED: was 2.0f
